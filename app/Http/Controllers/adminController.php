    ...
    public function gallery()
    {
        ...
        if(isset($_SESSION['id']))
        {
            ...
            foreach($categories as $category)
            {
                ...
                <td ><a target='_blank' rel='noopener noreferrer' href='/admin/gallery/category/images?category_id=$category->id '> صورة : $images </a></td>
                <td>$category->created_at </td>
                <td><a role='button' class='btn btn-primary' href='/admin/gallery/category/edit?id=$category->id'>تعديل</a >
                    <a role='button' class='btn btn-primary' onclick= 'return confirm(\"are you sure you want to delete this category : $category->name\")' href='/admin/gallery/category/delete?id=$category->id&name=$category->category_img'>مسح</a>
             </td>
            </tr>
                ";
            }
